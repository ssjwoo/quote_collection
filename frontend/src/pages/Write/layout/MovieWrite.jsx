...
export const MovieWrite = () =>{
    ...
    return(
        ...
        <Form className="flex flex-col mt-10">
            <div className="text-3xl mb-5">New Movie Write</div>
            <div className="flex items-end mt-3">
                <label className="w-1/5 text-end pb-2">영화 제목 <span className="text-red-700">*</span></label>
                <input type="text" className="w-4/6 outline-1 rounded-lg p-2 pl-4 shadow-lg ml-3 shadow-gray-400 outline-main-green" placeholder="영화 제목을 입력하세요" value={title} onChange={e=>setTitle(e.target.value)} />
            </div>
            <div className="flex items-end mt-3">
                <label className="w-1/5 text-end pb-2">감독 <span className="text-red-700">*</span></label>
                <input type="text" className="w-4/6 outline-1 rounded-lg p-2 pl-4 shadow-lg ml-3 shadow-gray-400 outline-main-green" placeholder="감독 정보를 입력하세요" value={director} onChange={e=>setDirector(e.target.value)} />
            </div>
            <div className="flex items-end mt-3">
